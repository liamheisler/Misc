...
void silentNight() 
{
  ...
  freqout(PIN,3*qnt/2,notes[G]);
  freqout(PIN,qnt/4,2*notes[A]);
  freqout(PIN,qnt/2,notes[G]);
  freqout(PIN,2*qnt,notes[E]);
  freqout(PIN,3*qnt/2,notes[G]);
  freqout(PIN,qnt/4,2*notes[A]);
  freqout(PIN,qnt,notes[G]);
  freqout(PIN,3*qnt,notes[E]);
  freqout(PIN,2*qnt,2*notes[D]);
  freqout(PIN,qnt,2*notes[D]);
  freqout(PIN,3*qnt/2,2*notes[B]);
  freqout(PIN,qnt*2,2*notes[C]);
  freqout(PIN,qnt,2*notes[C]);
  freqout(PIN,qnt*3,notes[G]);

  freqout(PIN,qnt*2,2*notes[A]);
  freqout(PIN,qnt,2*notes[A]);
  freqout(PIN,3*qnt/2,2*notes[C]);
  freqout(PIN,qnt/4,2*notes[B]);
  freqout(PIN,qnt,2*notes[A]);
  freqout(PIN,3*qnt/2,notes[G]);
  freqout(PIN,qnt/4,2*notes[A]);
  freqout(PIN,qnt,notes[G]);
  ...
  freqout(PIN,3*qnt,notes[E]);
  freqout(PIN,qnt*2,2*notes[D]);
  freqout(PIN,qnt,2*notes[D]);
  freqout(PIN,qnt,2*notes[F]);
  freqout(PIN,qnt,2*notes[D]);
  freqout(PIN,qnt/2,2*notes[B]);
  freqout(PIN,3*qnt/2,2*notes[C]);
  freqout(PIN,3*qnt/2,2*notes[E]);
  freqout(PIN,qnt,2*notes[C]);
  freqout(PIN,qnt,notes[G]);
  freqout(PIN,qnt,notes[E]);
  freqout(PIN,3*qnt/2,notes[G]);
  freqout(PIN,qnt/4,notes[F]);
  freqout(PIN,qnt,notes[D]);
  freqout(PIN,3*qnt,notes[C]);
}
